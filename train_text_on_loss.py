...
@Ruiyu
2019.03.11
This script only trains with text data.
"Training Loss" is the #1 decisive factor for saving model.
Then only GCS-labeled scipts are tested and 
    text_weight after AttentionLayer is recorded along with sentence.
'''
## TRAING PARAMS
batch_size = 32
epoch_count = 100
