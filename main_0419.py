...
#train_label0,train_text0,train_audio_left0,train_audio_right0 = gakki.get_trainer(average=True)
...
if __name__ == "__main__":
    ...
    for i in range(epo[1]):
        ...
        loss_t, acc_t = text_model.evaluate(test_text_,
                                            test_label_,
                                            batch_size=batch_size,
                                            verbose=0)
        print('>>>epoch: ', str(i))
